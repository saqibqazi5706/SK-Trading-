    ...
    <section className="bg-slate-50 dark:bg-slate-950 py-16 sm:py-20">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <form className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  name="name"
                  className="mt-1 w-full rounded-md border border-slate-300 dark:border-slate-700 px-3 py-2 text-sm text-slate-900 dark:text-slate-50 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
