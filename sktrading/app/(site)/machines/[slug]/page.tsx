            ...
            <dl className="mt-6 grid grid-cols-2 gap-4 text-sm">
              {machine.year && (
                <div>
                  ...
                  <dd className="font-semibold text-slate-900 dark:text-slate-50">{machine.year}</dd>
                </div>
              )}
              {machine.condition && (
                <div>
              ...
              {machine.brand && (
                <div>
                  ...
                  <dd className="font-semibold text-slate-900 dark:text-slate-50">{machine.brand}</dd>
                </div>
              )}
              {machine.origin && (
                <div>
